...
parser.add_argument('-tp', '--takeprofit', default=1.0, type=float, help='float, Percentage of Take Profit"-sl 0.8" ')
parser.add_argument('-i', '--interval', default=3, type=int, help='int, time interval as minute"-i 1" ')
...
def main():
    ...
    try:
        ...
        twm.start_kline_futures_socket(callback=ps.handle_kline_msg, symbol=args.symbol, interval=str(args.interval) + "m")
